	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      <li class="nav-item active">
	        <a class="nav-link" href="profile.jsp"><span class="fa fa-bell-o"></span> Learn Coding <span class="sr-only">(current)</span></a>
	      </li>
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="#" data-toggle="modal" data-target="#add-post-modal"><span class="fa fa-pencil"></span> Do Post</a>
	      </li>
	    </ul>
		...
		<div class="row my-4">
			<div class="col-md-8 offset-md-2 ">
				...
				<div class="card">
					...
					<div class="card-body">
						<img class="card-img-top my-2" src="post_pics/<%= p.getPpic() %>" alt="picture">
					...
					<div class="class-footer primary-background" style="padding:8px;">
					...
					%>
						...
						<a href="#" onclick="doLike(<%= p.getPid() %>, <%= p.getUserid() %>)" class="btn btn-outline-light btn-sm"><i class="fa fa-thumbs-o-up"></i><span class="like-counter"><%= ld.countLikeOnPost(p.getPid()) %></span></a>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        <button id="close-profile-button" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
